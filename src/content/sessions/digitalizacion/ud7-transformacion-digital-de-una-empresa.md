---
title: "Transformación digital de una empresa"
label: "UD7 · Proyecto final"
section: "ud-07"
order: 7
lang: "es"
...
outcomes:
  ...
  - "Justificar cada tecnología por el problema que resuelve, no por su nombre."
...
La transformación digital ocurre cuando utilizamos tecnología para cambiar procesos, reducir tareas manuales, conectar información, mejorar servicios, utilizar mejor los datos, tomar mejores decisiones u ofrecer nuevas formas de trabajar con clientes y empleados.
...
<figure class="diagram">
  <figcaption>Una automatización de la empresa</figcaption>
  <ol class="flow flow--row flow--chain">
...
<figure class="diagram">
  <figcaption>De guardar a decidir</figcaption>
  <ol class="flow flow--row flow--chain">
    <li>Guardar</li>
    <li>Analizar</li>
    <li>Comprender</li>
...
<div class="compare-pair">
  <div>
    ...
    <p class="compare-body">15 minutos para gestionar administrativamente una intervención.</p>
  </div>
  <div>
    <p class="compare-label">Después</p>
    <p class="compare-body">5 minutos.</p>
  </div>
</div>
