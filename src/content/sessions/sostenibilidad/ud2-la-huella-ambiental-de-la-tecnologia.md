---
title: "La huella ambiental de la tecnología"
label: "UD2 · Actividad"
section: "ud-02"
order: 2
lang: "es"
...
outcomes:
  ...
  - "Diferenciar economía lineal y economía circular."
  - "Manejar las ideas básicas de energía, emisiones, residuos electrónicos y consumo de agua."
...
<figure class="diagram">
  <figcaption>Economía lineal</figcaption>
...
<figure class="diagram">
  <figcaption>Economía circular</figcaption>
  <ol class="flow flow--row flow--chain flow--after">
    <li>Reducir</li>
    <li>Mantener</li>
    <li>Reparar</li>
    <li>Reutilizar</li>
    <li>Reacondicionar</li>
    <li>Reciclar</li>
  </ol>
</figure>
...
| Opción | Qué implica |
| ------ | ----------- |
| A | Comprar un portátil nuevo |
| B | Cambiar la batería |
| C | Usarlo para otra tarea menos exigente |
| D | Reacondicionarlo y entregarlo a otro usuario |

La economía circular no dice cuál elegir. Dice qué preguntar antes:
...
Residuos de Aparatos Eléctricos y Electrónicos: ordenadores, móviles, pantallas, routers, impresoras, discos y baterías.
...
La decisión equilibra cinco cosas a la vez:

<figure class="diagram">
  <figcaption>Lo que hay que pesar en cada decisión</figcaption>
  <ol class="flow flow--row flow--chain">
    <li>Impacto</li>
    <li>Coste</li>
    <li>Seguridad</li>
...
<p class="term">Ecodiseño</p>

Consiste en pensar en el impacto ambiental **desde que se diseña el producto**. En hardware significa facilitar reparaciones, usar piezas reemplazables, reducir materiales, permitir actualizaciones, mejorar la durabilidad y facilitar el reciclaje.
...
<p class="term">Intensidad de carbono</p>

Podemos entenderla como cuántas emisiones lleva asociadas producir una cantidad determinada de electricidad. Una red que funciona sobre todo con carbón tendrá normalmente una intensidad mayor que otra basada en renovables, nuclear u otras fuentes bajas en carbono.
...
*Power Usage Effectiveness*. La idea sencilla es comparar toda la energía que usa el centro de datos con la que usan directamente los equipos informáticos. Si también gastamos energía en refrigeración, iluminación y sistemas auxiliares, el consumo total es mayor.
