...
<div class="today-box">
  ...
  <ol class="today-steps">
    <li><strong>Comprende:</strong> una especificación ambigua trasladada directamente a código solo oculta decisiones sin tomar.</li>
    <li><strong>Construye:</strong> un modelo del problema y una lista de supuestos validados.</li>
...
Al terminar serás capaz de **convertir el enunciado en actores, casos de uso, reglas, entidades y criterios de aceptación**.

### 2. El problema

Una especificación ambigua trasladada directamente a código solo oculta decisiones sin tomar.
...
<div class="checkpoint">
  ...
  <ul class="checklist">
    <li>Has obtenido un modelo del problema y una lista de supuestos validados.</li>
...
<div class="today-box">
  <p class="today-label">Plan de la sesión · estructura publicada</p>
  <ol class="today-steps">
    <li><strong>Comprende:</strong> copiar la arquitectura del ejercicio anterior puede no encajar con el nuevo dominio.</li>
    <li><strong>Construye:</strong> un diseño inicial defendible y suficientemente pequeño para evolucionar.</li>
    <li><strong>Comprueba:</strong> demuestra el resultado sin depender del ejemplo guiado.</li>
  </ol>
</div>
...
Al terminar serás capaz de **diseñar capas, módulos, contratos y esquema relacional en función de los riesgos**.

### 2. El problema

Copiar la arquitectura del ejercicio anterior puede no encajar con el nuevo dominio.
...
<div class="checkpoint">
  <p class="checkpoint-label">Evidencia prevista</p>
  <ul class="checklist">
    <li>Has obtenido un diseño inicial defendible y suficientemente pequeño para evolucionar.</li>
    <li>Puedes explicar qué parte resuelve el problema de partida.</li>
    <li>Has probado al menos un caso correcto y un caso límite o de error.</li>
    <li>El cambio queda integrado en la aplicación común del curso.</li>
  </ul>
...
<div class="today-box">
  <p class="today-label">Plan de la sesión · estructura publicada</p>
  <ol class="today-steps">
    <li><strong>Comprende:</strong> crear todas las capas por separado retrasa la primera evidencia de que el sistema funciona.</li>
    <li><strong>Construye:</strong> un caso de uso completo y desplegable como base del proyecto.</li>
    <li><strong>Comprueba:</strong> demuestra el resultado sin depender del ejemplo guiado.</li>
  </ol>
</div>
...
Al terminar serás capaz de **construir un primer corte vertical ejecutable desde la petición hasta la persistencia**.

### 2. El problema

Crear todas las capas por separado retrasa la primera evidencia de que el sistema funciona.
...
<div class="checkpoint">
  <p class="checkpoint-label">Evidencia prevista</p>
  <ul class="checklist">
    <li>Has obtenido un caso de uso completo y desplegable como base del proyecto.</li>
    <li>Puedes explicar qué parte resuelve el problema de partida.</li>
    <li>Has probado al menos un caso correcto y un caso límite o de error.</li>
    <li>El cambio queda integrado en la aplicación común del curso.</li>
  </ul>
