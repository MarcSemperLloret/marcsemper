...
<div class="today-box">
  ...
  <ol class="today-steps">
    <li><strong>Comprende:</strong> la lista en memoria pierde información y no permite compartir un estado duradero.</li>
    <li><strong>Construye:</strong> un diseño inicial que conecta clases, tablas y claves.</li>
...
Al terminar serás capaz de **relacionar objetos, tablas e identidad sin confundir el modelo de dominio con el esquema físico**.

### 2. El problema

La lista en memoria pierde información y no permite compartir un estado duradero.
...
<div class="checkpoint">
  ...
  <ul class="checklist">
    <li>Has obtenido un diseño inicial que conecta clases, tablas y claves.</li>
...
<div class="today-box">
  <p class="today-label">Plan de la sesión · estructura publicada</p>
  <ol class="today-steps">
    <li><strong>Comprende:</strong> la aplicación necesita credenciales, URL y driver correctos sin incrustar secretos en el código.</li>
    <li><strong>Construye:</strong> un arranque verificado contra PostgreSQL.</li>
    <li><strong>Comprueba:</strong> demuestra el resultado sin depender del ejemplo guiado.</li>
  </ol>
</div>
...
Al terminar serás capaz de **crear la base de datos y configurar una conexión reproducible desde Spring Boot**.

### 2. El problema

La aplicación necesita credenciales, URL y driver correctos sin incrustar secretos en el código.
...
<div class="checkpoint">
  <p class="checkpoint-label">Evidencia prevista</p>
  <ul class="checklist">
    <li>Has obtenido un arranque verificado contra PostgreSQL.</li>
    <li>Puedes explicar qué parte resuelve el problema de partida.</li>
    <li>Has probado al menos un caso correcto y un caso límite o de error.</li>
    <li>El cambio queda integrado en la aplicación común del curso.</li>
  </ul>
...
<div class="today-box">
  <p class="today-label">Plan de la sesión · estructura publicada</p>
  <ol class="today-steps">
    <li><strong>Comprende:</strong> el repositorio en memoria debe sustituirse sin trasladar SQL a los controllers.</li>
    <li><strong>Construye:</strong> una entidad persistida y recuperada desde una capa repository.</li>
    <li><strong>Comprueba:</strong> demuestra el resultado sin depender del ejemplo guiado.</li>
  </ol>
</div>
...
Al terminar serás capaz de **mapear una clase con @Entity y acceder a ella mediante JpaRepository**.

### 2. El problema

El repositorio en memoria debe sustituirse sin trasladar SQL a los controllers.
...
<div class="checkpoint">
  <p class="checkpoint-label">Evidencia prevista</p>
  <ul class="checklist">
    <li>Has obtenido una entidad persistida y recuperada desde una capa repository.</li>
    <li>Puedes explicar qué parte resuelve el problema de partida.</li>
    <li>Has probado al menos un caso correcto y un caso límite o de error.</li>
    <li>El cambio queda integrado en la aplicación común del curso.</li>
  </ul>
